/**
 * Auto-generated thin instance for `stepfun`.
...
export class StepfunTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'stepfun',
        message: 'Transport "stepfun" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'stepfun', defaultBaseURL: 'https://api.stepfun.com/v1' };
  }
}
