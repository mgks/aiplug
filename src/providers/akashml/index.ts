/**
 * Auto-generated thin instance for `akashml`.
...
export class AkashmlTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'akashml',
        message: 'Transport "akashml" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'akashml', defaultBaseURL: 'https://api.akashml.com/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.akashml.com/v1';
