/**
 * Auto-generated thin instance for `friendli`.
...
export class FriendliTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'friendli',
        message: 'Transport "friendli" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'friendli', defaultBaseURL: 'https://api.friendli.ai/serverless/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.friendli.ai/serverless/v1';
