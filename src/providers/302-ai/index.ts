/**
 * Auto-generated thin instance for `302-ai`.
...
export class _302AiTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: '302-ai',
        message: 'Transport "302-ai" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: '302-ai', defaultBaseURL: 'https://api.302.ai/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.302.ai/v1';
