/**
 * Auto-generated thin instance for `wandb`.
...
export class WandbTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'wandb',
        message: 'Transport "wandb" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'wandb', defaultBaseURL: 'Evaluation registry' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'Evaluation registry';
