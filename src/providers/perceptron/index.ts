/**
 * Auto-generated thin instance for `perceptron`.
...
export class PerceptronTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'perceptron',
        message: 'Transport "perceptron" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'perceptron', defaultBaseURL: 'Custom gateway' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'Custom gateway';
