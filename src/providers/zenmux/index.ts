/**
 * Auto-generated thin instance for `zenmux`.
...
export class ZenmuxTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'zenmux',
        message: 'Transport "zenmux" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'zenmux', defaultBaseURL: 'https://zenmux.ai/api/v1' };
  }
}
