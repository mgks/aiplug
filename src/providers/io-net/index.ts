/**
 * Auto-generated thin instance for `io-net`.
...
export class IoNetTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'io-net',
        message: 'Transport "io-net" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'io-net', defaultBaseURL: 'https://api.intelligence.io.solutions/api/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.intelligence.io.solutions/api/v1';
