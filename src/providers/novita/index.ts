/**
 * Auto-generated thin instance for `novita`.
...
export class NovitaTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'novita',
        message: 'Transport "novita" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'novita', defaultBaseURL: 'https://api.novita.ai/openai/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.novita.ai/openai/v1';
