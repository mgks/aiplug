/**
 * Auto-generated thin instance for `dashscope`.
...
export class DashscopeTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'dashscope',
        message: 'Transport "dashscope" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'dashscope', defaultBaseURL: 'https://dashscope-intl.aliyuncs.com/compatible-mode/v1' };
  }
}
