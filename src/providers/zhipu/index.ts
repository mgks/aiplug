/**
 * Auto-generated thin instance for `zhipu`.
...
export class ZhipuTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'zhipu',
        message: 'Transport "zhipu" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'zhipu', defaultBaseURL: 'https://open.bigmodel.cn/api/paas/v4' };
  }
}
