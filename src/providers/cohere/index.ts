/**
 * Auto-generated thin instance for `cohere`.
...
export class CohereTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'cohere',
        message: 'Transport "cohere" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'cohere', defaultBaseURL: 'https://api.cohere.com/v2' };
  }
}
