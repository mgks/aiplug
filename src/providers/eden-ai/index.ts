/**
 * Auto-generated thin instance for `eden-ai`.
...
export class EdenAiTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'eden-ai',
        message: 'Transport "eden-ai" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'eden-ai', defaultBaseURL: 'https://api.edenai.co/v2' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.edenai.co/v2';
