/**
 * Auto-generated thin instance for `bedrock-aws`.
...
export class BedrockAwsTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'bedrock-aws',
        message: 'Transport "bedrock-aws" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'bedrock-aws', defaultBaseURL: 'https://bedrock-runtime.us-east-1.amazonaws.com' };
  }
}
