/**
 * Auto-generated thin instance for `kong-ai-gateway`.
...
export class KongAiGatewayTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'kong-ai-gateway',
        message: 'Transport "kong-ai-gateway" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'kong-ai-gateway', defaultBaseURL: 'Self-hosted / enterprise' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'Self-hosted / enterprise';
