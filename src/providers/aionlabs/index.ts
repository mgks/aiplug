/**
 * Auto-generated thin instance for `aionlabs`.
...
export class AionlabsTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'aionlabs',
        message: 'Transport "aionlabs" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'aionlabs', defaultBaseURL: 'https://api.aionlabs.ai/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.aionlabs.ai/v1';
