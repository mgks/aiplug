/**
 * Auto-generated thin instance for `jan`.
...
export class JanTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'jan',
        message: 'Transport "jan" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'jan', defaultBaseURL: 'http://localhost:1337/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'http://localhost:1337/v1';
