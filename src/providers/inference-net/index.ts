/**
 * Auto-generated thin instance for `inference-net`.
...
export class InferenceNetTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'inference-net',
        message: 'Transport "inference-net" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'inference-net', defaultBaseURL: 'https://api.inference.net/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.inference.net/v1';
