/**
 * Auto-generated thin instance for `mistral`.
...
export class MistralTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'mistral',
        message: 'Transport "mistral" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'mistral', defaultBaseURL: 'https://api.mistral.ai/v1' };
  }
}
