/**
 * Auto-generated thin instance for `aimlapi`.
...
export class AimlapiTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'aimlapi',
        message: 'Transport "aimlapi" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'aimlapi', defaultBaseURL: 'https://api.aimlapi.com/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.aimlapi.com/v1';
