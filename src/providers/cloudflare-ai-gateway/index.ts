/**
 * Auto-generated thin instance for `cloudflare-ai-gateway`.
...
export class CloudflareAiGatewayTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'cloudflare-ai-gateway',
        message: 'Transport "cloudflare-ai-gateway" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'cloudflare-ai-gateway', defaultBaseURL: 'https://gateway.ai.cloudflare.com/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://gateway.ai.cloudflare.com/v1';
