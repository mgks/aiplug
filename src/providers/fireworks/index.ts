/**
 * Auto-generated thin instance for `fireworks`.
...
export class FireworksTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'fireworks',
        message: 'Transport "fireworks" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'fireworks', defaultBaseURL: 'https://api.fireworks.ai/inference/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.fireworks.ai/inference/v1';
