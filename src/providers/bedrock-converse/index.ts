/**
 * Auto-generated thin instance for `bedrock-converse`.
...
export class BedrockConverseTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'bedrock-converse',
        message: 'Transport "bedrock-converse" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'bedrock-converse', defaultBaseURL: 'https://bedrock-runtime.us-east-1.amazonaws.com' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://bedrock-runtime.us-east-1.amazonaws.com';
