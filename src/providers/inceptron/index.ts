/**
 * Auto-generated thin instance for `inceptron`.
...
export class InceptronTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'inceptron',
        message: 'Transport "inceptron" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'inceptron', defaultBaseURL: 'Custom endpoint' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'Custom endpoint';
