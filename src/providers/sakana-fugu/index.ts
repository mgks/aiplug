/**
 * Auto-generated thin instance for `sakana-fugu`.
...
export class SakanaFuguTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'sakana-fugu',
        message: 'Transport "sakana-fugu" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'sakana-fugu', defaultBaseURL: 'https://api.sakana.ai/v1' };
  }
}
