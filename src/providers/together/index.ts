/**
 * Auto-generated thin instance for `together`.
...
export class TogetherTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'together',
        message: 'Transport "together" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'together', defaultBaseURL: 'https://api.together.xyz/v1' };
  }
}
