/**
 * Auto-generated thin instance for `xai`.
...
export class XaiTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'xai',
        message: 'Transport "xai" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'xai', defaultBaseURL: 'https://api.x.ai/v1' };
  }
}
