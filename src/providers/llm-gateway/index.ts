/**
 * Auto-generated thin instance for `llm-gateway`.
...
export class LlmGatewayTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'llm-gateway',
        message: 'Transport "llm-gateway" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'llm-gateway', defaultBaseURL: 'https://api.llmgateway.io/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.llmgateway.io/v1';
