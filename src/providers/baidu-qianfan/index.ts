/**
 * Auto-generated thin instance for `baidu-qianfan`.
...
export class BaiduQianfanTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'baidu-qianfan',
        message: 'Transport "baidu-qianfan" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'baidu-qianfan', defaultBaseURL: 'https://api.baiduqianfan.ai/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.baiduqianfan.ai/v1';
