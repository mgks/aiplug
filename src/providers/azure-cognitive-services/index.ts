/**
 * Auto-generated thin instance for `azure-cognitive-services`.
...
export class AzureCognitiveServicesTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'azure-cognitive-services',
        message: 'Transport "azure-cognitive-services" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'azure-cognitive-services', defaultBaseURL: 'https://<resource>.cognitiveservices.azure.com/openai/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://<resource>.cognitiveservices.azure.com/openai/v1';
