/**
 * Auto-generated thin instance for `siliconflow`.
...
export class SiliconflowTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'siliconflow',
        message: 'Transport "siliconflow" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'siliconflow', defaultBaseURL: 'https://api.siliconflow.cn/v1' };
  }
}
