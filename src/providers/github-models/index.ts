/**
 * Auto-generated thin instance for `github-models`.
...
export class GithubModelsTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'github-models',
        message: 'Transport "github-models" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'github-models', defaultBaseURL: 'https://models.inference.ai.azure.com' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://models.inference.ai.azure.com';
