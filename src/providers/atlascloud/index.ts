/**
 * Auto-generated thin instance for `atlascloud`.
...
export class AtlascloudTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'atlascloud',
        message: 'Transport "atlascloud" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'atlascloud', defaultBaseURL: 'https://api.atlascloud.ai/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.atlascloud.ai/v1';
