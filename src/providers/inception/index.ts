/**
 * Auto-generated thin instance for `inception`.
...
export class InceptionTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'inception',
        message: 'Transport "inception" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'inception', defaultBaseURL: 'https://api.inceptionlabs.ai/v1' };
  }
}
