/**
 * Auto-generated thin instance for `prism-api`.
...
export class PrismApiTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'prism-api',
        message: 'Transport "prism-api" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'prism-api', defaultBaseURL: 'https://sub2api.558686.xyz/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://sub2api.558686.xyz/v1';
