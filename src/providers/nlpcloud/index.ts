/**
 * Auto-generated thin instance for `nlpcloud`.
...
export class NlpcloudTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'nlpcloud',
        message: 'Transport "nlpcloud" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'nlpcloud', defaultBaseURL: 'https://api.nlpcloud.io/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.nlpcloud.io/v1';
