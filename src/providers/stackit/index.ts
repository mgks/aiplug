/**
 * Auto-generated thin instance for `stackit`.
...
export class StackitTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'stackit',
        message: 'Transport "stackit" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'stackit', defaultBaseURL: 'https://api.openai-compat.model-serving.eu01.onstackit.cloud/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.openai-compat.model-serving.eu01.onstackit.cloud/v1';
