/**
 * Auto-generated thin instance for `openinference`.
...
export class OpeninferenceTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'openinference',
        message: 'Transport "openinference" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'openinference', defaultBaseURL: 'Tracing / observability' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'Tracing / observability';
