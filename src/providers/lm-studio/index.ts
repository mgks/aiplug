/**
 * Auto-generated thin instance for `lm-studio`.
...
export class LmStudioTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'lm-studio',
        message: 'Transport "lm-studio" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'lm-studio', defaultBaseURL: 'http://localhost:1234/v1' };
  }
}
