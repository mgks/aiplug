/**
 * Auto-generated thin instance for `switchpoint`.
...
export class SwitchpointTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'switchpoint',
        message: 'Transport "switchpoint" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'switchpoint', defaultBaseURL: 'https://api.ppq.ai' };
  }
}
