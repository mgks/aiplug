/**
 * Auto-generated thin instance for `xiaomi`.
...
export class XiaomiTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'xiaomi',
        message: 'Transport "xiaomi" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'xiaomi', defaultBaseURL: 'Custom endpoint' };
  }
}
