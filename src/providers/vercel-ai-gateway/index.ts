/**
 * Auto-generated thin instance for `vercel-ai-gateway`.
...
export class VercelAiGatewayTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'vercel-ai-gateway',
        message: 'Transport "vercel-ai-gateway" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'vercel-ai-gateway', defaultBaseURL: 'https://ai-gateway.vercel.sh/v1' };
  }
}
