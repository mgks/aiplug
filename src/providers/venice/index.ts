/**
 * Auto-generated thin instance for `venice`.
...
export class VeniceTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'venice',
        message: 'Transport "venice" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'venice', defaultBaseURL: 'https://api.venice.ai/api/v1' };
  }
}
