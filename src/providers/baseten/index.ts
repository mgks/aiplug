/**
 * Auto-generated thin instance for `baseten`.
...
export class BasetenTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'baseten',
        message: 'Transport "baseten" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'baseten', defaultBaseURL: 'https://model-{id}.api.baseten.co/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://model-{id}.api.baseten.co/v1';
