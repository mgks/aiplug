/**
 * Auto-generated thin instance for `groq`.
...
export class GroqTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'groq',
        message: 'Transport "groq" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'groq', defaultBaseURL: 'https://api.groq.com/openai/v1' };
  }
}
