/**
 * Auto-generated thin instance for `glhf`.
...
export class GlhfTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'glhf',
        message: 'Transport "glhf" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'glhf', defaultBaseURL: 'https://glhf.chat/api/openai/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://glhf.chat/api/openai/v1';
