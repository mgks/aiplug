/**
 * Auto-generated thin instance for `nextbit`.
...
export class NextbitTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'nextbit',
        message: 'Transport "nextbit" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'nextbit', defaultBaseURL: 'https://api.nextbit256.com/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.nextbit256.com/v1';
