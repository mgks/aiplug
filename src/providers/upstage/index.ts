/**
 * Auto-generated thin instance for `upstage`.
...
export class UpstageTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'upstage',
        message: 'Transport "upstage" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'upstage', defaultBaseURL: 'https://api.upstage.ai/v1/solar' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.upstage.ai/v1/solar';
