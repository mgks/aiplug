/**
 * Auto-generated thin instance for `poolside`.
...
export class PoolsideTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'poolside',
        message: 'Transport "poolside" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'poolside', defaultBaseURL: 'https://divers.poolsi.de/openai/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://divers.poolsi.de/openai/v1';
