/**
 * Auto-generated thin instance for `opper`.
...
export class OpperTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'opper',
        message: 'Transport "opper" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'opper', defaultBaseURL: 'https://api.opper.ai/v3/compat' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.opper.ai/v3/compat';
