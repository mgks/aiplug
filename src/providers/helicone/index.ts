/**
 * Auto-generated thin instance for `helicone`.
...
export class HeliconeTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'helicone',
        message: 'Transport "helicone" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'helicone', defaultBaseURL: 'https://ai-gateway.helicone.ai/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://ai-gateway.helicone.ai/v1';
