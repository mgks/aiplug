/**
 * Auto-generated thin instance for `snowflake-cortex`.
...
export class SnowflakeCortexTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'snowflake-cortex',
        message: 'Transport "snowflake-cortex" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'snowflake-cortex', defaultBaseURL: 'https://<account>.snowflakecomputing.com/api/v2/cortex/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://<account>.snowflakecomputing.com/api/v2/cortex/v1';
