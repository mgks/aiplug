/**
 * Auto-generated thin instance for `hyperbolic`.
...
export class HyperbolicTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'hyperbolic',
        message: 'Transport "hyperbolic" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'hyperbolic', defaultBaseURL: 'https://api.hyperbolic.xyz/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.hyperbolic.xyz/v1';
