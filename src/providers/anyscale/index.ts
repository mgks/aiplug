/**
 * Auto-generated thin instance for `anyscale`.
...
export class AnyscaleTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'anyscale',
        message: 'Transport "anyscale" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'anyscale', defaultBaseURL: 'https://api.endpoints.anyscale.com/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.endpoints.anyscale.com/v1';
