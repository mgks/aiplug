/**
 * Auto-generated thin instance for `gmicloud`.
...
export class GmicloudTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'gmicloud',
        message: 'Transport "gmicloud" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'gmicloud', defaultBaseURL: 'https://api.gmi-serving.com/v1' };
  }
}
