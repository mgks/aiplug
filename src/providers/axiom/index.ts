/**
 * Auto-generated thin instance for `axiom`.
...
export class AxiomTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'axiom',
        message: 'Transport "axiom" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'axiom', defaultBaseURL: 'https://cloud.axiomstudio.ai/rest/v1/llm-gateway/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://cloud.axiomstudio.ai/rest/v1/llm-gateway/v1';
