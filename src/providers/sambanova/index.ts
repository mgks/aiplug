/**
 * Auto-generated thin instance for `sambanova`.
...
export class SambanovaTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'sambanova',
        message: 'Transport "sambanova" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'sambanova', defaultBaseURL: 'https://api.sambanova.ai/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.sambanova.ai/v1';
