/**
 * Auto-generated thin instance for `perplexity`.
...
export class PerplexityTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'perplexity',
        message: 'Transport "perplexity" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'perplexity', defaultBaseURL: 'https://api.perplexity.ai' };
  }
}
