/**
 * Auto-generated thin instance for `portkey`.
...
export class PortkeyTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'portkey',
        message: 'Transport "portkey" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'portkey', defaultBaseURL: 'https://api.portkey.ai/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.portkey.ai/v1';
