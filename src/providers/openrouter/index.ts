/**
 * Auto-generated thin instance for `openrouter`.
...
export class OpenrouterTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'openrouter',
        message: 'Transport "openrouter" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'openrouter', defaultBaseURL: 'https://openrouter.ai/api/v1' };
  }
}
