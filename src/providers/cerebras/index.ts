/**
 * Auto-generated thin instance for `cerebras`.
...
export class CerebrasTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'cerebras',
        message: 'Transport "cerebras" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'cerebras', defaultBaseURL: 'https://api.cerebras.ai/v1' };
  }
}
