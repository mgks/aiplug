/**
 * Auto-generated thin instance for `clarifai`.
...
export class ClarifaiTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'clarifai',
        message: 'Transport "clarifai" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'clarifai', defaultBaseURL: 'Custom endpoints' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'Custom endpoints';
