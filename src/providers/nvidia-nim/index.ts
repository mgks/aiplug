/**
 * Auto-generated thin instance for `nvidia-nim`.
...
export class NvidiaNimTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'nvidia-nim',
        message: 'Transport "nvidia-nim" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'nvidia-nim', defaultBaseURL: 'https://integrate.api.nvidia.com/v1' };
  }
}
