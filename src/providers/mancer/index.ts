/**
 * Auto-generated thin instance for `mancer`.
...
export class MancerTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'mancer',
        message: 'Transport "mancer" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'mancer', defaultBaseURL: 'https://mancer.tech/oai/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://mancer.tech/oai/v1';
