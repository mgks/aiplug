/**
 * Auto-generated thin instance for `google-ai-studio`.
...
export class GoogleAiStudioTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'google-ai-studio',
        message: 'Transport "google-ai-studio" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'google-ai-studio', defaultBaseURL: 'https://generativelanguage.googleapis.com' };
  }
}
