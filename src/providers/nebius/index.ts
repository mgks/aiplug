/**
 * Auto-generated thin instance for `nebius`.
...
export class NebiusTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'nebius',
        message: 'Transport "nebius" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'nebius', defaultBaseURL: 'https://api.studio.nebius.ai/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.studio.nebius.ai/v1';
