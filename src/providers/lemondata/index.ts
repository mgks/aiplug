/**
 * Auto-generated thin instance for `lemondata`.
...
export class LemondataTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'lemondata',
        message: 'Transport "lemondata" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'lemondata', defaultBaseURL: 'https://api.lemondata.ai/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.lemondata.ai/v1';
