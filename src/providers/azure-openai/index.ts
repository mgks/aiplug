/**
 * Auto-generated thin instance for `azure-openai`.
...
export class AzureOpenaiTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'azure-openai',
        message: 'Transport "azure-openai" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'azure-openai', defaultBaseURL: 'https://<resource>.openai.azure.com/openai/v1' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://<resource>.openai.azure.com/openai/v1';
