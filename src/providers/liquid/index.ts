/**
 * Auto-generated thin instance for `liquid`.
...
export class LiquidTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'liquid',
        message: 'Transport "liquid" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'liquid', defaultBaseURL: 'Custom cluster endpoints' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'Custom cluster endpoints';
