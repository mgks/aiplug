/**
 * Auto-generated thin instance for `infermatic`.
...
export class InfermaticTransport extends OpenAICompatibleTransport {
  constructor(config: ProviderConfig) {
    if (!config.baseURL) {
      throw makeError({
        code: 'INVALID_CONFIGURATION',
        transport: 'infermatic',
        message: 'Transport "infermatic" requires a baseURL',
      });
    }
    super(config);
  }
  ...
  override capabilities(): TransportMetadata {
    ...
    return { ...m, name: 'infermatic', defaultBaseURL: 'https://api.totalgpt.ai' };
  }
}

/** Canonical default base URL for this provider. */
export const DEFAULT_BASE_URL = 'https://api.totalgpt.ai';
